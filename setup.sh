...
if [ ! -f eclipse-jee-2020-03-R-incubation-linux-gtk-x86_64.tar.gz ]; then
	echo
	echo "*** Download Eclipse ***"
	echo
    wget http://www.mirrorservice.org/sites/download.eclipse.org/eclipseMirror/technology/epp/downloads/release/2020-03/R/eclipse-jee-2020-03-R-incubation-linux-gtk-x86_64.tar.gz
fi
if [ ! -d $ECLIPSE ]; then
	echo
